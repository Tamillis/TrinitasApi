...
- **Witchcraft** - the Occult which involves bargaining with hidden or outer entities, unconvering corrupt rituals and daring to utter words of power.
...
**Potency**: Powerful (Replace Evasion with Intelligence and +2 to that Defence to avoid injuries) = +2

**Duration**: Sustained (Per Fight) = +1, with Concentration = -1
...
- For area spells the affected characters make an appropriate roll to prevent the effect vs a TN = the Magnitude + 1

On a spell's success, the caster rolls for damage to generate an Injury or applies the condition as normal. If a target's Armour should reduce damage, as it was physical in nature or some other effect allows for armour-like damage reduction, do so.
