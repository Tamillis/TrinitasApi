...
Many RPGs have a "Charisma" statistic where a single number determines all of a character's social interactions - a key pillar of play. Trinitas has opted to not have such a stat, instead relying on all its other stats during interaction. A clear paradigm of interaction with characters exists. This paradigm, and the skills and stats that affect it, are:
- **Entertain** with *Music* or a *Charm*-ing performance (Agility) - makes an NPC happier and more amenable.
- **Impress** with *Charm* (Spirit) or *Logic* (Intelligence) - puts an NPC in a more favourable disposition to you and your party, more likely to heed your words or treat you favourably.
- **Deceive** with *Deception* (Intelligence) - get an NPC to believe a falsehood is true, such as your party being without weapons.
- **Intimidate** with *Initimidation* (Strength) or forbidden / incriminating *Knowledge* (Intelligence)  - get an NPC to fear you and the consequences.
- **Convince** with *Persuade* (Intelligence) or *Art*-ful performance (Agility) - moving or arguing an NPC into supporting you.
- **Fathom** a target's state of mind with *Insight* (Perception) - lay a targets motives and thoughts bare, and suss out whether they tell a truth or lie
